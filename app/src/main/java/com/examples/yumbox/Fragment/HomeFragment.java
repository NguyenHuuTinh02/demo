...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.viewAllMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BottomSheetDialogFragment bottomSheetDialogFragment = new com.examples.yumbox.Fragment.MenuBottomSheetFragment();
    ...
    private void randomPopularItems() {
        ...
        // New menu item list with random items
        ArrayList<MenuItem> subnetMenuItems = new ArrayList<>();
        for (int i = 0; i < numItemToShow; i++) {
            subnetMenuItems.add(menuItems.get(indices.get(i)));
        }
